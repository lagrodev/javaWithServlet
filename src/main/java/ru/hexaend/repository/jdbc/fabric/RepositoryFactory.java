 ...
 *
 * <p>Принимает интерфейс репозитория и создаёт его прокси-реализацию, в которой каждый метод
 * обрабатывается {@link RepositoryInvocationHandler}: SQL берётся из аннотации {@code @Query},
 * маппер — из {@code @Mapper}.
 *
