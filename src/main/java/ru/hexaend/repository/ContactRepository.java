 ...
 *
 * <p>Расширяет базовый {@link MyRepository} специализированными
 * методами поиска по фамилии, номеру телефона и подстроке имени.</p>
 *
...
public interface ContactRepository extends MyRepository<Contact, UUID> {
    ...
    /**
     * Ищет контакты, у которых имя или фамилия содержат указанную подстроку
     * (регистронезависимо).
     *
