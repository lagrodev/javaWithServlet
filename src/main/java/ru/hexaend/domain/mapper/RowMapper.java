...
/**
 * Функциональный интерфейс для преобразования текущей строки {@link ResultSet} в объект указанного
 * типа.
 *
...
public interface RowMapper<T> {
  ...
  /**
   * Преобразует текущую строку результата запроса в объект. Курсор {@code rs} уже установлен на
   * нужную строку.
   *
