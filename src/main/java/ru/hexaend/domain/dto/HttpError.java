 ...
 *
 * <p>Каждая константа несёт числовой статус-код, краткий код (reason phrase) и человекочитаемое
 * описание. Используется в {@link ApplicationException} и {@link ErrorFilter} вместо «магических»
 * чисел.
 *
