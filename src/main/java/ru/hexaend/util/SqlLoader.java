 ...
 *
 * <p>Читает {@code .sql} файлы из {@code src/main/resources/} и возвращает
 * их содержимое как строку. Результаты кэшируются для избежания
 * повторного чтения с диска.</p>
 *
...
public final class SqlLoader {
     ...
     *
     * <p>При первом вызове ресурс читается с диска и помещается в кэш.
     * Последующие вызовы возвращают закэшированное значение.</p>
     *
