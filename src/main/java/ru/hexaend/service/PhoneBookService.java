 ...
 *
 * <p>Определяет операции создания, редактирования, удаления и поиска контактов. Реализация
 * выполняет валидацию входных данных и делегирует работу с хранилищем в {@link
 * ru.hexaend.repository.ContactRepository}.
 *
...
public interface PhoneBookService {
  ...
  /**
   * Создаёт новый контакт с указанными данными. Валидирует телефоны через {@link
   * ru.hexaend.util.PhoneValidator}.
   *
